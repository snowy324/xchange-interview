<template>
    <div class="cloud-error-m">
        ...
        <div class="cloud-error-opps-m">
            Opps, something went wrong.
        </div>
        <div class="cloud-error-msg-m">
            {{searchError?.message}}
        </div>
    </div>
</template>
...
@Component
export default class CloudErrorMobile extends Vue {
    @CloudTravaleModule.State('searchError') searchError!: AxiosError
}
</script>
